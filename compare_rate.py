...
if __name__ == "__main__":
    ...
    parser.add_argument('--graphLimits',     dest='graphLimits',     help='comma separated list of final graph y axis limits, default is 14,18', required = False, default="10,10")
...
#        cpm.lumi = str(args.lumi + " fb^{-1}")
        ...
        c.Draw()
        if args.add: 
            c.Print(outputFolder_qcd + "/{}_rateParam_{}.png".format(model,args.add))
        else:
            c.Print(outputFolder_qcd + "/{}_rateParam.png".format(model))
